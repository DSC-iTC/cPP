...
|Test Group
|In the context of cryptographic algorithm testing, a configuration of cryptographic algorithm properties (key size, hash algorithm, etc.) and a set of test cases which correspond to these properties.
