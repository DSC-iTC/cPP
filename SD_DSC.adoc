...
The evaluator shall develop and execute or verify and observe the developer tooling which selects the seed source and provides it to the DRBG. The evaluator shall verify that the request succeeds.
