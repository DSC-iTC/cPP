...
+
*_Key encapsulation* - If the STF claims key encapsulation, then it should use approved methods such as those listed in CKM.2._
+
*_Key wrapping* - If the STF claims key wrapping, then it should use approved methods such as KW, or KWP._
+
*_Key encryption* - If the STF claims key encryption, then it should use approved methods such as those in FCS_COP.1/SK._
+
