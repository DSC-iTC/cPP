...
* S.CApp - CApp (i.e. an authorized user or an application with a verifiable identity) with security attribute CApp.ID - See <<Roles>> for more discussion on user roles.
...
Although there is another section written about SDEs and SDOs, this section is used to map keys and authentication tokens to SDEs and SDOs. This cPP does not impose a strict structure on the items in the key hierarchy. An X.509 certificate is one example of a strict structure of a key with attributes. Collecting attributes of an SDE and composing an SDO structure with an SDE and attribute fields imposes temporal and storage penalties in all cases. In certain resource-constrained cases the attributes could be implicit. 
...
|NIST SP 800-56B Rev 2 (Section 8.2)
...
|KDF
|{empty}[*selection*: [.underline]#KDF-CTR, KDF-FB, KDF-DPI]# with concatenated keys as input using {empty}[*selection*: [.underline]#AES-128-CMAC; AES-192-CMAC; AES-256-CMAC, HMAC-SHA-1; HMAC-SHA-224; HMAC-SHA-256; HMAC-SHA-384; HMAC-SHA-512; HMAC-SHA3-224; HMAC-SHA3-256; HMAC-SHA3-384; HMAC-SHA3-512]# as the PRF.
...
|RSA-PKCS
|RSASSA-PKCS1-v1_5 using {empty}[*selection*: [.underline]#SHA-224, SHA-256, SHA-384, SHA-512, SHA3-224, SHA3-256, SHA3-384, SHA3-512#]
...
|RSA-PSS
|RSASSA-PSS using {empty}[*selection*: [.underline]#SHA-224, SHA-256, SHA-384, SHA-512, SHA3-224 SHA3-256, SHA3-384, SHA3-512#]
|{empty}[*selection*: [.underline]#2048, 3072, 4096#] bits
...
|ECDSA
|ECDSA on {empty}[*selection*: [.underline]#brainpoolP256r1, brainpoolP384r1, brainpoolP512r1, NIST P-256, NIST P-384, NIST P-521#] using {empty}[*selection*: [.underline]#SHA-224, SHA-256, SHA-384, SHA-512, SHA3-224 SHA3-256, SHA3-384, SHA3-512#]
|{empty}[*selection*: [.underline]#256, 384, 512#] bits
...
{empty}[*selection*: [.underline]#ISO/IEC 10118-3:2018 (Clause 10, 14), FIPS PUB 180-4#] [SHA]
...
{empty}[*selection*: [.underline]#ISO/IEC 10118-3:2018 (Clause 10, 14), FIPS PUB 180-4, FIPS PUB 202#] [SHA]

|LMS
|{empty}[*selection*: [.underline]#LMS, HSS]#
|{empty}[*selection*: [.underline]#208, 272, 408, 536, 808, 1064, 1600, 2120]#
|NIST SP 800-208

|XMSS
|{empty}[*selection*: [.underline]#XMSS, XMSS^MT^]#
|[*selection:* 408, 536]
|NIST SP 800-208

|===

_Application Note {counter:remark_count}_:: _FIPS 186-5 allows use of SHAKE128 and SHAKE256 for RSA-PSS and ECDSA._
+
_Elliptic Curve Algorithms, (e.g., ECDSA, EC-KCDSA) require random bits from an RBG per NIST FIPS 186-5 sections A.3.1 and A.3.2._
+
...
|ECDSA on {empty}[*selection*: [.underline]#brainpoolP256r1, brainpoolP384r1, brainpoolP512r1, NIST P-256, NIST P-384, NIST P-521#] using {empty}[*selection*: [.underline]#SHA-224, SHA-256, SHA-384, SHA-512, SHA3-224 SHA3-256, SHA3-384, SHA3-512#]
|{empty}[*selection*: [.underline]#256, 384, 512#] bits
|{empty}[*selection*: [.underline]#ISO/IEC 14888-3:2018 (Sub Clause 6.6), FIPS PUB 186-5 (Sections 6.3.1, 6.4.2)]# [ECDSA]
...
|Det-ECDSA
|Deterministic ECDSA on {empty}[*selection*: [.underline]#brainpoolP256r1, brainpoolP384r1, brainpoolP512r1, NIST P-256, NIST P-384, NIST P-521#] using {empty}[*selection*: [.underline]#SHA-224, SHA-256, SHA-384, SHA-512, SHA3-224 SHA3-256, SHA3-384, SHA3-512#]
|{empty}[*selection*: [.underline]#256, 384, 512#] bits
|{empty}[*selection*: [.underline]#ISO/IEC 14888-3:2018 (Sub Clause 6.6), FIPS PUB 186-5 (Sections 6.3.2, 6.4.2)]# [Deterministic ECDSA]
...
+
_FIPS 186-5 allows use of SHAKE128 and SHAKE256 for RSA-PSS and ECDSA._
+
...
|PBKDF
|NIST SP 800-132
|Salts shall be randomly generated.
...
|CFB
|SP 800-38A
|IVs shall be non-repeating as repeating IVs leak information about the first plaintext block and about common shared prefixes in messages.
...
FDP_SDI.2.1:: The TSF shall monitor *SDOs and SDEs* controlled by the TSF for [_integrity errors_] on all objects, based on the following attributes: [.underline]#*[selection: [_assignment: attribute associated with presence in protected storage_], cryptographic hash, message authentication code, digital signature, integrity-providing encryption algorithm as specified in FCS_COP.1/KeyWrap]*#.
...
+
_In addition to verifying the integrity of the firmware executing the TSF, the DSC should also verify the integrity of any data associated with the TSF (such as constants for cryptographic algorithms) as well as performing the KATs._
...
|[*selection*: FIPS PUB 186-5 (Section A.2.1), NIST SP 800-56A Rev 3 (Section 5.6.1.2.1)]

|AK3 
|ECDSA - Rejection Sampling
|{empty}[*selection*: [.underline]#256 bits (P-256, brainpoolP256r1), 384 bits (P-384, brainpoolP384r1), 512 bits (P-521, brainpoolP512r1)]#
|[*selection*: FIPS PUB 186-5 (Section A.2.2), NIST SP 800-56A Rev 3 (Section 5.6.1.2.2)]
...
|KDF in Counter Mode using {empty}[*selection*: [.underline]#AES-128-CMAC; AES-192-CMAC; AES-256-CMAC; HMAC-SHA-1; HMAC-SHA-224; HMAC-SHA-256; HMAC-SHA-384; HMAC-SHA-512; HMAC-SHA3-224; HMAC-SHA3-256; HMAC-SHA3-384; HMAC-SHA3-512]# as the PRF
|{empty}[*selection*: [.underline]#128, 192, 256]# bits 
|NIST SP 800-108 Rev 1 (Section 4.1) [KDF in Counter Mode]

{empty}[*selection*: [.underline]#ISO/IEC 9797-1:2011 (CMAC), NIST SP 800-38B (CMAC), ISO/IEC 18033-3:2010 (AES), ISO/IEC 9797-2:2021 (HMAC), FIPS PUB 198-1 (HMAC), ISO/IEC 10118-3:2018 (SHA), FIPS PUB 180-4 (SHA), FIPS PUB 202 (SHA3)]#

|KDF-FB
|{empty}[*selection*: [.underline]#Direct Generation from a Random Bit Generator as specified in FCS_RBG.1, Concatenated keys]#
|KDF in Feedback Mode using {empty}[*selection*: [.underline]#AES-128-CMAC; AES-192-CMAC; AES-256-CMAC; HMAC-SHA-1; HMAC-SHA-224; HMAC-SHA-256; HMAC-SHA-384; HMAC-SHA-512; HMAC-SHA3-224; HMAC-SHA3-256; HMAC-SHA3-384; HMAC-SHA3-512]# as the PRF
|{empty}[*selection*: [.underline]#128, 192, 256]# bits 
|NIST SP 800-108 Rev 1 (Section 4.2) [KDF in Feedback Mode]

{empty}[*selection*: [.underline]#ISO/IEC 9797-1:2011 (CMAC), NIST SP 800-38B (CMAC), ISO/IEC 18033-3:2010 (AES), ISO/IEC 9797-2:2021 (HMAC), FIPS PUB 198-1 (HMAC), ISO/IEC 10118-3:2018 (SHA), FIPS PUB 180-4 (SHA), FIPS PUB 202 (SHA3)]#

|KDF-DPI 
|{empty}[*selection*: [.underline]#Direct Generation from a Random Bit Generator as specified in FCS_RBG.1, Concatenated keys]#
|KDF in Double-Pipeline Iteration Mode using {empty}[*selection*: [.underline]#AES-128-CMAC; AES-192-CMAC; AES-256-CMAC; HMAC-SHA-1; HMAC-SHA-224; HMAC-SHA-256; HMAC-SHA-384; HMAC-SHA-512; HMAC-SHA3-224; HMAC-SHA3-256; HMAC-SHA3-384; HMAC-SHA3-512]# as the PRF
|{empty}[*selection*: [.underline]#128, 192, 256]# bits 
|NIST SP 800-108 Rev 1 (Section 4.3) [KDF in Double-Pipeline Iteration Mode]

{empty}[*selection*: [.underline]#ISO/IEC 9797-1:2011 (CMAC), NIST SP 800-38B (CMAC), ISO/IEC 18033-3:2010 (AES), ISO/IEC 9797-2:2021 (HMAC), FIPS PUB 198-1 (HMAC), ISO/IEC 10118-3:2018 (SHA), FIPS PUB 180-4 (SHA), FIPS PUB 202 (SHA3)]#

|KDF-KMAC
|{empty}[*selection*: [.underline]#Direct Generation from a Random Bit Generator as specified in FCS_RBG.1, Concatenated keys]#
|KDF using {empty}[*selection*: [.underline]#KMAC128, KMAC256]#
|{empty}[*selection*: [.underline]#128, 192, 256]# bits
...
{empty}[*selection*: [.underline]#AES-128-CMAC; AES-192-CMAC; AES-256-CMAC; HMAC-SHA-1; HMAC-SHA-224; HMAC-SHA-256; HMAC-SHA-384; HMAC-SHA-512; HMAC-SHA3-224; HMAC-SHA3-256; HMAC-SHA3-384; HMAC-SHA3-512]# as the MAC and;

[KDF Step] 

{empty}[*selection*: [.underline]#KDF-CTR, KDF-FB, KDF-DPI]# using {empty}[*selection*: [.underline]#AES-128-CMAC; AES-192-CMAC; AES-256-CMAC; HMAC-SHA-1; HMAC-SHA-224; HMAC-SHA-256; HMAC-SHA-384; HMAC-SHA-512; HMAC-SHA3-224; HMAC-SHA3-256; HMAC-SHA3-384; HMAC-SHA3-512]# as the PRF.
...
FPT_STM_EXT.1.1:: The TSF shall be able to provide reliable a [*selection*: internal time stamp, external time stamp, monotonically increasing counter] to measure the passage of time.
