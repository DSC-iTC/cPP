...
|KAS2
|RSA
|&#91; *selection:* [.underline]#2048, 3072, 4096, 6144, 8192]# bits
|NIST SP 800-56B Rev 2 (Section 8.3)

|DH
|Diffie-Hellman
|&#91; *selection:* [.underline]#2048, 3072, 4096, 6144, 8192]# bits
|NIST SP 800-56A Rev 3, &#91; *selection:* RFC 3526 (Section [.underline]#[*selection:* 3, 4, 5, 6, 7]), RFC 7919 (Appendixes [*selection:* A.1, A.2, A.3, A.4, A.5]#)]

|ECDH-NIST
|ECDH with NIST curves
|&#91; *selection:* [.underline]#256 (P-256), 384 (P-384), 512 (P-521)]#
|NIST SP 800-56A

|ECDH-BPC
|ECDH with Brainpool curves
|&#91; *selection:* [.underline]#256 (brainpoolP256r1), 384 (brainpoolP384r1), 512 (brainpoolP512r1)]#
|RFC 5639 (Section 3)

|ECDH-Ed
|ECDH with Edwards Curves
|&#91; *selection:* [.underline]#256, 448]# bits
|RFC 7748

|ECIES
|ECIES
|&#91; *selection:* [.underline]#256, 384, 512]# bits
|&#91; *selection:* [.underline]#ANSI X9.63, IEEE 1363a, ISO/IEC 18033-2 Part 2, SECG SEC1 sec 5.1]#

|KDF
|&#91; *selection:* [.underline]#KDF-CTR, KDF-FB, KDF-DPI]# with concatenated keys as input using &#91; *selection:* [.underline]#AES-128-CMAC; AES-192-CMAC; AES-256-CMAC, HMAC-SHA-1; HMAC-SHA-256; HMAC-SHA-512]# as the PRF.
|&#91; *selection:* [.underline]#128, 192, 256]# bits
|NIST SP 800-108 (Section 5) [KDF]

&#91; *selection:* [.underline]#ISO/IEC 9797-1:2011 (CMAC), NIST SP 800-38B (CMAC), ISO/IEC 18033-3:2010 (AES), ISO/IEC 9797-2:2021 (HMAC), FIPS PUB 198-1 (HMAC), ISO/IEC 10118-3:2018 (SHA), FIPS PUB 180-4 (SHA)]# 
...
+
_If XOR is selected, the selection-based SFR FCS_CKM.5 must be claimed by the TOE._
...
=== Cryptographic Support
EdDSA==== FCS_CKM.1/AKG Cryptographic Key Generation - Asymmetric Keys
...
|AK1 
|RSA 
|&#91; *selection:* [.underline]#2048 bit, 3072 bit]#
|FIPS PUB 186-5 (Section A.1.1)

|AK2 
|ECDSA - Extra Random Bits 
|&#91; *selection:* [.underline]#256 bits (P-256, brainpoolP256r1), 384 bits (P-384, brainpoolP384r1), 512 bits (P-521, brainpoolP512r1)]#
...
|AK4 
|DSA 
|Bit lengths of p and q respectively (L, N) &#91; *selection:* [.underline]#(3072, 256)]#
|BSI TR-02102-1 (Section 6.3.2) [Key generation]

|AK5 
|EdDSA 
|&#91; *selection:* [.underline]#256 (Edwards25519), 448 (Edwards448)]# bits
|[*selection:* FIPS PUB 186-5 (Section A.2.3), RFC 8032]

|
|KCDSA
|&#91; *selection:* [.underline]#(2048, 224) bit, (2048, 256) bit]#
|ISO/IEC 14888-3:2018 (subclause 6.3) [KCDSA]

|
|EC-KCDSA
|&#91; *selection:* [.underline]#224 (P-224, B-233, K-233), 256 (P-256, B-283, K-283)]#
...
|&#91; *selection:* [.underline]#128, 192, 256, 512]# bits 
...
|KDF-CTR 
|&#91; *selection:* [.underline]#Direct Generation from a Random Bit Generator as specified in FCS_RBG.1, Concatenated keys]#
|KDF in Counter Mode using &#91; *selection:* [.underline]#AES-128-CMAC; AES-192 -CMAC; AES-256 -CMAC; HMAC-SHA-1; HMAC-SHA-256; HMAC-SHA-512]# as the PRF
|&#91; *selection:* [.underline]#128, 192, 256]# bits 
...
|KDF-FB
|&#91; *selection:* [.underline]#Direct Generation from a Random Bit Generator as specified in FCS_RBG.1, Concatenated keys]#
|KDF in Feedback Mode using &#91; *selection:* [.underline]#AES-128-CMAC; AES-192 -CMAC; AES-256 -CMAC; HMAC-SHA-1; HMAC-SHA-256; HMAC-SHA-512]# as the PRF
|&#91; *selection:* [.underline]#128, 192, 256]# bits 
...
|KDF in Double-Pipeline Iteration Mode using &#91; *selection:* [.underline]#AES-128-CMAC; AES-192 -CMAC; AES-256 -CMAC; HMAC-SHA-1; HMAC-SHA-256; HMAC-SHA-512]# as the PRF
|&#91; *selection:* [.underline]#128, 192, 256]# bits 
...
&#91; *selection:* [.underline]#AES-128-CMAC; AES-192 -CMAC; AES-256 -CMAC; HMAC-SHA-1; HMAC-SHA-256; HMAC-SHA-512]# as the EEF and;

[KDF Step] 

&#91; *selection:* [.underline]#KDF-CTR, KDF-FB, KDF-DPI]# using &#91; *selection:* [.underline]#AES-128-CMAC; AES-192-CMAC; AES-256-CMAC; HMAC-SHA-1; HMAC-SHA-256; HMAC-SHA-512]# as PRF.
...
FCS_CKM.5 Cryptographic Key Derivation, requires the TSF to perform key derivation using a defined method.

*Management: FCS_CKM_EXT.4, FCS_CKM.5*

No specific management functions are identified.

*Audit: FCS_CKM_EXT.4, FCS_CKM.5*
...
[vertical]
FCS_CKM.5.1:: The TSF shall generate cryptographic keys with[_assignment: key types_] using [_assignment: input parameters_], key derivation algorithm [_assignment: key derivation algorithms_], and specified cryptographic key sizes [_assignment: key sizes_] that meet the following: [_assignment: list of standards_].
