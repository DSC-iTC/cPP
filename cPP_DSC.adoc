...
+
_Specifying the subject-object-operation combinations that are always permitted, those combinations that are conditionally permitted, and combinations with rules such as blacket prohibition of access is sufficient. The focus is on combinations where access is specifically permitted or rejected._
+
