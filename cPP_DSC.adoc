...
_Application Note {counter:remark_count}_:: _The selections in this SFR should be consistent with the algorithms selected in FCS_CKM_EXT.7._
...
FCS_SLT_EXT.1.1:: The TSF shall use salts and nonces generated by an RBG as specified in FCS_RBG.1.
